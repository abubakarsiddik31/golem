...
// Client streams responses through the same deployments endpoint as
// Generate.
...
type streamAssembler struct {
	...
	// thinking accumulates reasoning fragments from deployments that
	// return a reasoning_content field on deltas.
