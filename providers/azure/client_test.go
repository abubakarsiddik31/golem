...
func TestNewRejectsInvalidSamplingControls(t *testing.T) {
	...
	for name, cfg := range map[string]azure.Config{
		"negative temperature": {APIKey: "k", Endpoint: "https://e", Deployment: "d", APIVersion: "v", Temperature: invalid(-0.1)},
		"hot temperature":      {APIKey: "k", Endpoint: "https://e", Deployment: "d", APIVersion: "v", Temperature: invalid(2.1)},
		"top P above one":      {APIKey: "k", Endpoint: "https://e", Deployment: "d", APIVersion: "v", TopP: invalid(1.1)},
		"negative max tokens":  {APIKey: "k", Endpoint: "https://e", Deployment: "d", APIVersion: "v", MaxTokens: -1},
	} {
		if _, err := azure.New(cfg); err == nil {
